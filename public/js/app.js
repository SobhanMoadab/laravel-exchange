...
vue__WEBPACK_IMPORTED_MODULE_3__.default.use(vue_toastification__WEBPACK_IMPORTED_MODULE_1__.default, {
    ...
    formsubmit: function formsubmit() {
      ...
      if (!this.form.email) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/login', this.form).then(function (res) {
          ...
          _this.$toast.error(e.response.data.msg, {
            position: "top-right",
            timeout: 5000,
            closeOnClick: true,
            pauseOnFocusLoss: true,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      if (!this.form.email) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().post('/api/register', this.form).then(function (res) {
          ...
          if (e.response.data.errors.email) {
            ...
            for (var i = 0; i < e.response.data.errors.password.length; i++) {
              _this.$toast.error(e.response.data.errors.password[i], {
                position: "top-right",
                timeout: 5000,
                closeOnClick: true,
                pauseOnFocusLoss: true,
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().get('https://api.countrystatecity.in/v1/countries', {
      headers: {
        "X-CSCAPI-KEY": 'UGR3bHNNZU8zQWpwS2VnMElDeUVlQ3ZtcDI4eDdSWWpnTG5uZTNKNw=='
      }
    }).then(function (res) {
      _this2.countrys = res.data;
...
/* harmony import */ var _Pages_Site_Home_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Pages/Site/Home.vue */ "./resources/js/Pages/Site/Home.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vue_router__WEBPACK_IMPORTED_MODULE_7__.default({
  routes: [{
    ...
    path: '/',
    component: _Pages_Site_Home_vue__WEBPACK_IMPORTED_MODULE_3__.default
  }, {
    path: '/login',
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "fixed-backgrounds" }),
    _vm._v(" "),
    _c("main", [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "position-relative image-side " }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("a", { attrs: { href: "Dashboard.Default.html" } }, [
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("button", { staticClass: "btn btn-primary btn-lg btn-shadow" }, [
          _vm._v("REGISTER")
        ])
      ]
    )
...
var update = add("2ab950c9", content, false, {});
