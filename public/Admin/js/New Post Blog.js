(self["webpackChunk"] = self["webpackChunk"] || []).push([["New Post Blog"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    NewPost: function NewPost() {
      ...
      // create post blog function
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/dashboard/blog', this.form, {
        headers: {
          Authorization: "Bearer ".concat(sessionStorage.token)
        }
      }).then(function (res) {
        _this.post = res.data.blog;
        document.getElementById("save-btn").classList.add('btn-success');
        document.getElementById("save-btn").innerHTML = res.data.msg;
        setTimeout(function () {
        ...
        document.getElementById("save-btn").innerHTML = error.response.statusText;
        document.getElementById("save-btn").innerHTML = error.response.statusText;
        document.getElementById("save-btn").classList.remove('btn-outline-success');
        document.getElementById("save-btn").classList.add('btn-outline-danger');
        setTimeout(function () {
          document.getElementById("save-btn").innerHTML = 'save';
          document.getElementById("save-btn").classList.remove('btn-outline-danger');
          document.getElementById("save-btn").classList.add('btn-outline-success');
        }, 3000);
      });
    },
    //update post blog function
    upPost: function upPost() {
      axios__WEBPACK_IMPORTED_MODULE_0___default().put('/api/dashboard/blog/' + this.post.id, this.form, {
        headers: {
          Authorization: "Bearer ".concat(sessionStorage.token)
        }
      }).then(function (res) {
  ...
  return _c("main", [
    _c("div", { staticClass: "container-fluid" }, [
      ...
      _c("input", {
        ...
        staticClass: "form-control w-95 mx-auto mb-5",
        attrs: {
          type: "text",
          name: "post_name",
          placeholder: "Enter Name Posts"
        },
            ...
            _c("div", { staticClass: "card-body" }, [
              _c("div", { staticClass: "tab-content" }, [
                _c(
                  ...
                  [
                    _c("h5", { staticClass: "mb-4" }, [_vm._v("Details")]),
                    _vm._v(" "),
                    _c("textarea", {
                      directives: [
                        {
                      ...
                      attrs: { name: "content-post", placeholder: "blog text" },
          ...
          _c("div", { staticClass: "card mb-4" }, [
            ...
            _c("div", { staticClass: "card-body" }, [
              ...
              _c(
                "button",
                {
                  staticClass: "w-100 btn btn-outline-success mb-1 ",
                  attrs: { id: "save-btn" },
                  on: {
              ...
              _c(
                "button",
                {
                  staticClass: "w-100 btn d-none btn-outline-info mb-1 ",
                  attrs: { id: "update-btn" },
                  on: {
                    click: function($event) {
                      return _vm.upPost()
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "card mb-4" }, [
      _c("div", { staticClass: "card-body" }, [
        _c("div", { staticClass: "glide details" }, [
          _c(
            "div",
            {
            ...
            [
              _c("ul", { staticClass: "glide__slides" }, [
                _c("li", { staticClass: "glide__slide" }, [
                  _c("img", {
                    staticClass:
                      "responsive border-0 border-radius img-fluid mb-3",
                    attrs: { alt: "detail", src: "/img/products/parkin.jpg" }
                  })
                ])
              ])
            ]
  ...
  function() {
    ...
    return _c(
      ...
      [
          ...
          [
            _c("a", { attrs: { href: "#" } }, [
              _c("img", {
                ...
                attrs: { src: "/img/profiles/l-7.jpg", alt: "Mimi Carreira" }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "pl-3 flex-grow-1" }, [
              _c("a", { attrs: { href: "#" } }, [
                _c("p", { staticClass: "font-weight-medium mb-0" }, [
                  _vm._v("Mimi Carreira")
                ]),
                _vm._v(" "),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "comment-likes" }, [
              _c("span", { staticClass: "post-icon" }, [
                _c("a", { attrs: { href: "#" } }, [
                  _c("span", [_vm._v("12 Likes")]),
                  _vm._v(" "),
                  _c("i", { staticClass: "simple-icon-heart ml-2" })
                ])
              ])
            ])
          ]
          ...
          [
            _c("a", { attrs: { href: "#" } }, [
              _c("img", {
                staticClass:
                  "img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall",
                attrs: { src: "/img/profiles/l-3.jpg", alt: "Kathryn Mengel" }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "pl-3 flex-grow-1" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "comment-contaiener" }, [
            ...
            _c("div", { staticClass: "input-group-append" }, [
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("i", { staticClass: "simple-icon-arrow-right ml-2" })
                ]
              )
            ])
          ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "mb-3" }, [
      _c("div", { staticClass: "post-icon mr-3 d-inline-block" }, [
        _c("a", { attrs: { href: "#" } }, [
          _c("i", { staticClass: "simple-icon-heart mr-1" })
        ]),
        _vm._v(" "),
        _c("span", [_vm._v("4\n                                      Likes")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "post-icon d-inline-block" }, [
        _c("i", { staticClass: "simple-icon-bubble mr-1" }),
        _vm._v(" "),
        _c("span", [_vm._v("1\n                                      Comment")])
      ])
    ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card mb-4 d-none d-lg-block" }, [
      _c("div", { staticClass: "card-body" }, [
        _c("h5", { staticClass: "card-title" }, [
          _c("span", [_vm._v("Similar Projects")]),
          _c(
            "a",
            {
              staticClass: "btn-link float-right text-small pt-1",
              attrs: { href: "#" }
            },
            [_vm._v("View All")]
          )
        ...
        _vm._v(" "),
        _c("div", { staticClass: "row social-image-row gallery" }, [
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/marble-cake.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/marble-cake-thumb.jpg" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/parkin.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/parkin-thumb.jpg" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/fruitcake.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/fruitcake-thumb.jpg" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/tea-loaf.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/tea-loaf-thumb.jpg" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/napoleonshat.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/napoleonshat-thumb.jpg" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-6" }, [
            _c("a", { attrs: { href: "img/products/magdalena.jpg" } }, [
              _c("img", {
                staticClass: "img-fluid border-radius",
                attrs: { src: "/img/products/magdalena-thumb.jpg" }
              })
            ])
          ])
        ])
