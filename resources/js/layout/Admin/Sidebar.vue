        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="#layouts">
                            <i class="iconsminds-file"></i> Posts
                        </a>
                    </li>
                    <li>
                        <a href="#applications">
                            <i class="iconsminds-library"></i> Page
                        </a>
                    </li>
                    <li>
                        <a href="#ui">
            ...
            <div class="scroll">
                ...
                <ul class="list-unstyled" data-link="layouts" id="layouts">
                        ...
                        <div class="collapse show">
                            <ul class="list-unstyled inner-level-menu" @click="handleClick($event)">
                                <li>
                                    <router-link to="/admin/posts">
                                        <i class="simple-icon-user-following"></i> <span
                                            class="d-inline-block">Posts</span>
                                    </router-link>
                                </li>
                                <li>
                                    <router-link to="/admin/posts/new-post">
                                        <i class="simple-icon-user-follow"></i> <span
                                            class="d-inline-block">New Posts</span>
                                    </router-link>
                                </li>
                                <li>
                                    <router-link to="/admin/category">
                                        <i class="simple-icon-user-unfollow"></i> <span class="d-inline-block">Category</span>
                                    </router-link>
                                </li>
                            </ul>
                        </div>
