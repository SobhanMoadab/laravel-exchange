...
<script>
    function change_icon(base_64) {
        $('#img_icon').attr('src', `data:image/png;base64,${base_64}`);
    }
    $(document).ready(() => {
        $.ajax({
            url: '/api/currency',
