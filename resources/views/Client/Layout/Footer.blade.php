    ...
    <section class="bg-footer bg-light">
        <a href="#" class="ticket-show bg-warning link-dark"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
